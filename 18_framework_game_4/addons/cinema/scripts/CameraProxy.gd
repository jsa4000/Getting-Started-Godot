@tool
class_name CameraProxy extends Camera3D
@icon("../icons/icon_camera.svg")

signal camera_enabled(camera)

@export_placeholder var id : String #setget _set_id

#@export var enabled : bool = false #setget _set_enabled
var enabled : bool = false:
	set = _set_enabled
@export var priority : int = 0
@export var use_gimbal_position : bool = false
@export var type : Resource #setget _set_type
