class_name StatsPanel extends Label
...
@export var fps : bool = true #setget _set_fps
@export var draw_calls : bool = true #setget _set_draw_calls
@export var static_memory : bool = true #setget _set_static_memory
@export var dynamic_memory : bool = true #setget _set_dynamic_memory
@export var message_buffer : bool = false #setget _set_message_buffer
@export var resources_count : bool = false #setget _set_resources_count
@export var objects_count : bool = true #setget _set_objects_count
