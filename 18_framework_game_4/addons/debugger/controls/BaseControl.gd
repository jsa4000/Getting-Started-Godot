@tool
class_name BaseControl extends HBoxContainer

signal value_changed(control, value)	

enum Align { LEFT, RIGHT }

# Godot 4.0 error using properties in export
@export var hide_label: bool = false #setget _set_hide_label
@export_placeholder var text_label : String #setget _set_text_label
@export var align_label : int = Align.LEFT #setget _set_align_label
@export var min_size_label :Vector2 = Vector2.ZERO #setget _set_min_size_label
@export var flags_label : int = SIZE_EXPAND_FILL #setget _set_flags_label
