...
export(Rect2) var smooth_zone : Rect2 = Rect2(Vector2(0.1,0.1),Vector2(0.8,0.8)) setget _set_smooth_zone
export(Rect2) var dead_zone : Rect2 = Rect2(Vector2(0.4,0.4),Vector2(0.2,0.2))setget _set_dead_zone
export(Vector2) var offset : Vector2 = Vector2.ZERO setget _set_offset
...
func _init_anchors() -> void:
	var cube : CubeMesh = CubeMesh.new()
