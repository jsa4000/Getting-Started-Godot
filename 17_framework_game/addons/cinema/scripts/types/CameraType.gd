extends Resource
class_name CameraType

export(Vector3) var offset : Vector3 = Vector3(0,0,0) setget _set_offset	
export(float) var camera_fov : float = 80.0 setget _set_camera_fov
export(float, 0.0, 5.0, 0.0001) var camera_fov_speed : float = 1.0
export(bool) var noise_enabled : bool = false setget _set_noise_enabled	
export(float, 0.0, 1.0, 0.0001) var noise_translation_amount : float = 0.05
export(float, 0.0, 1.0, 0.0001) var noise_rotation_amount : float = 0.05
...
func init(parent: Camera, gimbal : Gimbal) -> void:
	_parent = parent
	self.gimbal = gimbal
