...
class_name Debugger , "../icons/icon.svg"

export(String) var footer : String setget _set_footer
export(bool) var show_stats : bool = true setget _set_show_stats
export(bool) var show_console : bool = false setget _set_show_console
export(Array, Resource) var refresh_subscriptions : Array
...
func _init_subscriptions():
	for sub in refresh_subscriptions:
		...
		node.connect(sub.signal_name, self, "_on_refresh")
