...
uniform float metalness:hint_range(0.0, 10.0) = 1.0;
uniform float roughness:hint_range(0.0, 10.0) = 1.0;
...
void fragment(){
	...
	ROUGHNESS = m_blend3.g * roughness;
	METALLIC = m_blend3.b * metalness;
	SPECULAR = specular;
	ALPHA = 1.0;
}