...
onready var joystick = get_parent().get_node("Control/VBoxContainer/HBoxContainer/CenterContainer/Joystick/JoystickButton")
...
func _process(_delta: float) -> void:
	...
	move_axis = Vector2(-joystick_vector.y, joystick_vector.x) 
...
func _input(event: InputEvent) -> void:
	...
	if event is InputEventScreenDrag && event.index != joystick.ongoing_drag:
